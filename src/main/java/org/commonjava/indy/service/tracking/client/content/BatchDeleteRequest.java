...
@Schema( description = "Request of batch files that will be removed from the repository. Specifying the folo"
                ...
                implements Externalizable
{
    ...
    {
        return "BatchDeleteRequest{" + "storeKey=" + storeKey + ", trackingID='" + trackingID + '\'' + ", paths="
                        + paths + '}';
    }
    ...
    public void readExternal( final ObjectInput in ) throws IOException, ClassNotFoundException
    {
        ...
        {
            throw new IOException( "Cannot deserialize. BatchDeleteRequest version in data stream is: "
                                                   + batchDeleteRequestVersion
                                                   + " but this class can only deserialize up to version: "
                                                   + BATCH_DELETE_REQUEST_VERSION );
        }
