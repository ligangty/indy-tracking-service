...
public class DtxTrackingRecord
{
    ...
    public DtxTrackingRecord( String trackingKey, Boolean state, String storeKey, String accessChannel, String path,
                              String originUrl, String localUrl, String storeEffect, String md5, String sha256,
                              String sha1, Long size, Long started, Set<Long> timestamps )
    {
    ...
    public DtxTrackingRecord( TrackedContentEntry entry )
    {
        ...
        this.timestamps = ( ( entry.getTimestamps() == null ) || entry.getTimestamps().isEmpty() ) ?
                        new HashSet<>() :
                        entry.getTimestamps();
    }
